...
class OrderForm
  ...
  attr_accessor :reward, :delivery_method, :employee, :street, :postcode, :city, :address_id, :order
  ...
  def save
    ...
    ActiveRecord::Base.transaction do
      ...
      @order = Order.create!(reward: r, reward_snapshot: r, address_snapshot: a, employee: employee)
