...
Kudo.create!(title: Faker::Hipster.word, content: Faker::Restaurant.review, giver_id: employee1.id, receiver_id: employee6.id, company_value: cv1)
Kudo.create!(title: Faker::Hipster.word, content: Faker::Restaurant.review, giver_id: employee2.id, receiver_id: employee5.id, company_value: cv2)
Kudo.create!(title: Faker::Hipster.word, content: Faker::Restaurant.review, giver_id: employee3.id, receiver_id: employee4.id, company_value: cv1)
Kudo.create!(title: Faker::Hipster.word, content: Faker::Restaurant.review, giver_id: employee4.id, receiver_id: employee3.id, company_value: cv2)
